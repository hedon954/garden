    ...
    <main className="page-shell garden-page">
      ...
      >
        <p className="garden-lede">
          Garden 以 Markdown 文件为内容源，提供博文、随想和专栏三种内容模型。
          内容保存在自己的 Git 仓库中，推送后由 GitHub Pages 自动发布。
        </p>
      ...
      <section className="garden-setup" id="setup" aria-labelledby="garden-setup-title">
        ...
        <div className="garden-setup-grid">
          ...
          <article>
            ...
            <h3>提交并发布</h3>
            <pre>
              <code>make update MESSAGE=&quot;发布第一篇文章&quot;</code>
            </pre>
            <p>
              命令会先完成检查，再提交并推送当前改动。main 分支更新后，Actions 自动生成页面、搜索索引、RSS 和 sitemap。
            </p>
          </article>
        </div>
